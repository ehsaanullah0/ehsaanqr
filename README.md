...
There are things that are part of the growing collection of small digital tools under the **EHSAAN** project.
...
## **Many QR Generators Give You This**
...
<table align="center">
  ...
  <tr>
    ...
    <td align="center">
      <img width="300" height="300" alt="ehsaan-qr-1024x1024 (6)" src="https://github.com/user-attachments/assets/e4942bcf-a37a-429a-9554-411c0075dc64" />
    </td>
  </tr>
</table>
...
* 🔗 **Multiple QR Types** — Create QR codes for URLs, text, contact details, Wi-Fi, and more
* 🎨 **Deep Customization** — Customize colours, shapes, eyes, patterns, and other QR elements
* 🎲 **Smart Randomization** — Generate unique QR designs with randomized visual elements
* 🖼️ **Logo Support** — Add a logo to make your QR code more recognizable
