...
export const DEFAULT_FORM_DATA: QrFormData = {
  ...
  text: {
    text: 'Hello from Ehsaan QR! Scan-ready and fast.',
  },
  wifi: {
    ssid: 'Home_WiFi_5G',
  ...
  email: {
    email: 'contact@ehsaan.odoo.com',
    subject: 'Project Inquiry',
    body: 'Hi there, I would like to learn more about your services.',
  },
  phone: {
  ...
  sms: {
    phone: '+1 555 234 5678',
    message: 'Hey! Check out this link.',
  },
  whatsapp: {
    phone: '15552345678',
    message: 'Hello! I scanned your Ehsaan QR code.',
  },
  vcard: {
    firstName: 'Ehsaan',
    lastName: 'Kareem',
    organization: 'Ehsaan Studio',
    title: 'Product Architect',
    phone: '+1 555 789 0123',
    email: 'hello@ehsaan.odoo.com',
    url: 'https://ehsaan.odoo.com',
  ...
  upi: {
    ...
    pn: 'Ehsaan Studio',
    am: '500.00',
    tn: 'Digital invoice payment',
  },
  calendar: {
    title: 'Product Strategy Review',
    location: 'Conference Room B / Meet Link',
    ...
    description: 'Quarterly architecture and release alignment.',
  },
};
