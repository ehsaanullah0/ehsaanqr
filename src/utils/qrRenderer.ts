...
// The Ehsaan flame SVG as an encoded data URL for canvas and SVG embedding
export const EHSAAN_FLAME_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none">
  <defs>
    <linearGradient id="flame-grad" x1="16" y1="4" x2="56" y2="56" gradientUnits="userSpaceOnUse">
      <stop offset="0%" stop-color="#FF4D4F"/>
      <stop offset="55%" stop-color="#DC2626"/>
      <stop offset="100%" stop-color="#991B1B"/>
    </linearGradient>
    <linearGradient id="inner-grad" x1="28" y1="24" x2="44" y2="48" gradientUnits="userSpaceOnUse">
      <stop offset="0%" stop-color="#FFA39E"/>
      <stop offset="100%" stop-color="#F87171"/>
    </linearGradient>
  </defs>
  <path d="M32 4C32 4 39.5 15.5 39.5 24C39.5 26.3 38.8 28.5 37.6 30.3C36.6 27.5 34.6 25.1 32 23.5C30.4 22.5 29.5 20.8 29.5 19C29.5 16.5 30.5 14.2 31.8 12.3C22.6 15.7 16 24.6 16 35C16 46.6 25.4 56 37 56C48.6 56 58 46.6 58 35C58 22.8 47.5 11.8 32 4Z" fill="url(#flame-grad)"/>
  <path d="M34 32C34 29.5 32.5 27 30 25.5C28.2 29.5 26 33.2 26 37C26 43.1 30.9 48 37 48C43.1 48 48 43.1 48 37C48 29 41.5 22.5 34 32Z" fill="url(#inner-grad)"/>
  <path d="M36 41C36 43.2 37.8 45 40 45C42.2 45 44 43.2 44 41C44 37.5 40.5 34.5 38 37C36.8 38.2 36 39.5 36 41Z" fill="#FFF1F0"/>
</svg>`;
...
export function resolvePupilShape(
  ...
  if (!pupilStyle || pupilStyle === 'auto') {
    ...
    if (eyeStyle === 'cut-corner') return 'diamond';
