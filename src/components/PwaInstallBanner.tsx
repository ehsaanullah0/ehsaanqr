...
export const PwaInstallBanner: React.FC<PwaInstallBannerProps> = ({ onShowToast }) => {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden rounded-2xl border border-[#EDE8DF] dark:border-zinc-800 bg-white/90 dark:bg-zinc-900/90 p-4 sm:p-5 shadow-xs transition-all hover:border-[#E7AC08]/40 dark:hover:border-[#E7AC08]/30"
    >
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        {/* Left Side: App identity & install description */}
        <div className="flex items-start sm:items-center gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-[#FFFBEA] dark:bg-zinc-800 border border-[#E7AC08]/30 flex items-center justify-center shrink-0 shadow-2xs">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h3 className="text-sm sm:text-base font-bold text-[#0F172A] dark:text-zinc-100 flex items-center gap-1.5">
                ...
                <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-[#E7AC08]/15 text-[#92400E] dark:text-[#E7AC08] border border-[#E7AC08]/30">
                  PWA
                </span>
              </h3>
            ...
            <p className="mt-0.5 text-xs text-[#64748B] dark:text-zinc-400 leading-relaxed">
        ...
        <div className="flex items-center gap-2.5 shrink-0 self-end sm:self-auto">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-bold text-xs sm:text-sm text-white bg-zinc-900 hover:bg-black dark:bg-zinc-100 dark:hover:bg-white dark:text-zinc-900 transition-all shadow-xs active:scale-98 cursor-pointer group"
      ...
      {infoMessage && (
        <div className="mt-3 p-2.5 rounded-xl bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900/40 text-xs text-amber-900 dark:text-amber-200 flex items-start justify-between gap-2">
          ...
          <button
            ...
            className="text-amber-700 dark:text-amber-400 hover:underline text-[11px] shrink-0 font-medium"
          >
            Dismiss
          </button>
        </div>
      ...
      {showIosGuide && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 animate-in fade-in">
          <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-zinc-900 p-5 shadow-xl border border-[#EDE8DF] dark:border-zinc-800 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-[#FFFBEA] dark:bg-zinc-800 border border-[#E7AC08]/30 flex items-center justify-center text-[#E7AC08]">
            ...
            <ol className="space-y-2 text-xs text-[#0F172A] dark:text-zinc-200">
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-[11px] font-bold flex items-center justify-center shrink-0">1</span>
                <span>Tap the <strong>Share</strong> button (box with an arrow) in the Safari toolbar.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-[11px] font-bold flex items-center justify-center shrink-0">2</span>
                <span>Scroll down and select <strong>Add to Home Screen</strong>.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-[11px] font-bold flex items-center justify-center shrink-0">3</span>
