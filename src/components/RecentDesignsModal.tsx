              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2 pt-0.5">
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      type="button"
                      id="btn-upload-template-txt"
                      onClick={() => fileInputRef.current?.click()}
                      className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-black hover:bg-zinc-800 active:scale-95 text-white dark:bg-black dark:hover:bg-zinc-900 dark:text-white border-2 border-black dark:border-zinc-700 text-xs font-black transition-all cursor-pointer shadow-md hover:shadow-lg ring-2 ring-black/10 dark:ring-white/10"
        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-xs animate-in fade-in">
          <div className="w-full max-w-lg bg-white dark:bg-zinc-900 rounded-2xl sm:rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-2xl p-4 sm:p-5 space-y-4">
            ...
            <div className="flex items-center justify-between gap-2 pt-1">
              <button
                type="button"
                id="btn-save-code-txt"
                onClick={handleDownloadCodeFile}
                className="flex items-center gap-2 px-4 py-2 rounded-xl bg-black hover:bg-zinc-800 active:scale-95 text-white dark:bg-black dark:hover:bg-zinc-900 dark:text-white border-2 border-black dark:border-zinc-700 text-xs font-black transition-all cursor-pointer shadow-md hover:shadow-lg ring-2 ring-black/10 dark:ring-white/10"
                title="Save template code to a .txt file"
              >
