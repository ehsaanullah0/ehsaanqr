...
export const ReadabilityDashboard: React.FC<ReadabilityDashboardProps> = ({
  ...
  return (
    <div
      ...
      className="w-full bg-white dark:bg-zinc-900/90 rounded-2xl border border-zinc-200/90 dark:border-zinc-800 shadow-2xs overflow-hidden transition-all"
    >
      {/* Header Bar */}
      <div className="p-3.5 sm:p-4 border-b border-zinc-100 dark:border-zinc-800/80 bg-zinc-50/70 dark:bg-zinc-950/40 flex flex-wrap items-center justify-between gap-2.5">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-xs sm:text-sm font-bold tracking-tight text-zinc-900 dark:text-zinc-100">
                QR Readability Intelligence
              </h3>
              <span className="text-[10px] font-medium px-1.5 py-0.5 rounded-md bg-zinc-200/80 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400">
                Estimated
              </span>
            </div>
      ...
      <div className="p-3.5 sm:p-4 space-y-3.5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5">
          ...
          <div className="p-2.5 rounded-xl bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200/60 dark:border-zinc-800">
            ...
            <span className="text-[10px] text-zinc-400 dark:text-zinc-500 mt-1 block capitalize">
        ...
        {isExpanded && (
          <div className="pt-2 border-t border-zinc-100 dark:border-zinc-800 space-y-3 animate-in fade-in-50">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {report.overallScore < 90 && (
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-red-600 hover:bg-red-700 active:bg-red-800 disabled:bg-zinc-300 dark:disabled:bg-zinc-800 text-white font-bold text-xs shadow-xs hover:shadow-sm transition-all active:scale-[0.98]"
            ...
            {onOpenScanner && (
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700/80 text-zinc-800 dark:text-zinc-200 font-semibold text-xs shadow-2xs transition-all active:scale-[0.98]"
              >
        ...
        <div className="text-[10px] text-zinc-400 dark:text-zinc-500 flex items-center gap-1 pt-0.5">
